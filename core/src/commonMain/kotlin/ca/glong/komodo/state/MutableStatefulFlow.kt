...
typealias MutableUnitStateFlow = ca.glong.komodo.state.MutableStateFlow<Unit, Throwable>

typealias DefaultStateFlow<T> = ImmutableStateFlow<T, Throwable>
typealias MutableDefaultStateFlow<T> = ca.glong.komodo.state.MutableStateFlow<T, Throwable>
