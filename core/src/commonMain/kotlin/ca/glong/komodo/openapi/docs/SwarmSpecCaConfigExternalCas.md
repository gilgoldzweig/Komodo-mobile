...
| **protocol** | [**SwarmSpecCaConfigExternalCasProtocolEnum**](SwarmSpecCaConfigExternalCasProtocolEnum.md) | Protocol for communication with the external CA (currently only &#x60;cfssl&#x60; is supported). |  [optional] |
