package ca.glong.komodo.core.openapi.infrastructure
...
import ca.glong.komodo.core.openapi.auth.*
...
open class ApiClient(
    ...
    private val authentications: kotlin.collections.Map<String, Authentication> by lazy {
        mapOf(
                "api-key" to ApiKeyAuth("header", "X-Api-Key"), 
                "api-secret" to ApiKeyAuth("header", "X-Api-Secret"), 
                "jwt" to ApiKeyAuth("header", "Authorization"))
    }
